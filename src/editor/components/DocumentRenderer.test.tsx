...
import { initialNoteDocument, type NoteDocument } from "../model/noteDocument";
...
describe("DocumentRenderer", () => {
  ...
  it("renders mention chips as non-editable atom nodes with stable data paths", () => {
    ...
    expect(html).toContain('data-path="/blocks/0/children/1"');
  ...
  it("renders figures as non-editable block atom nodes with stable data paths", () => {
    ...
    expect(html).toContain('data-path="/blocks/0"');
    expect(html).toContain('contentEditable="false"');
  ...
  it("renders rich text block variants with stable cursor paths", () => {
    ...
    expect(html).toContain('data-path="/blocks/1/children/0/text"');
    expect(html).toContain('class="list-item-block text-block"');
    expect(html).toContain('data-path="/blocks/2/children/0/text"');
    expect(html).toContain('class="code-block-text text-run"');
    expect(html).toContain('data-path="/blocks/3/text"');
  });
  ...
  it("reflects the current headless selection for inspection", () => {
    ...
    expect(html).toContain('data-selection-path="/blocks/0/children/1"');
